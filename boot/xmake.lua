...
target("boot.stage0.memlimit")
	set_kind("static")
	add_files("startup/stage0.S")
	add_asflags("-Xassembler --defsym -Xassembler STAGE0_MEMLIMIT=0")
...
rule("link.stage0-memlimit")
	on_load(function (target)
		target:add("deps", "boot.stage0.memlimit")
