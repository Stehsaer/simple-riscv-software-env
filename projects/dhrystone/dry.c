...
#define HZ (1)                 /* time() returns time in seconds */
								   // extern long     time(void*); /* see library function "time"  */
#define Too_Small_Time 2000000 /* Measurements should last at least 2 seconds */
#define Start_Timer() Begin_Time = _times((long*)0)
#define Stop_Timer() End_Time = _times((long*)0)
  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  fprintf (stderr, "\n");
    ...
    Microseconds = (double) User_Time 
                        / ((double) HZ * ((double) Number_Of_Runs));
    Dhrystones_Per_Second = Mic_secs_Per_Second / Microseconds  ;

    printf("\nStart tick: %ld, End tick: %ld\n", Begin_Time, End_Time);
